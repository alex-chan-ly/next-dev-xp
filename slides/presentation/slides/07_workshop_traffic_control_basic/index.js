...
import { step2, getPodsWithLabels, task1, task2 } from './messages'
import { MarkDownWrapper, TerminalLineWrapper, IframeWrapper, Iframe } from './style'

export default [
  <WorkshopHome
    title={`Traffic Control - Basic`}
    description={`Carry out a basic canary release, introducing a small proportion of request to a different version of a backend microservice`}
    difficulty={2}
    minutes={30}
    number={"03"} />,
